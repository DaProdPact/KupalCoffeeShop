  ...
  <div class="table container mt-3 mb-0">
        ...
        >
          ...
          <thead class="rounded-1 table-responsive primarybg">
            <tr>
              <th class="fw-bold" style="color:#6c5959;">Customer Fullname</th>
              <th class="fw-bold" style="color:#6c5959;">Home Address</th>
              <th class="fw-bold" style="color:#6c5959;">Contact Number</th>
              <th class="fw-bold" style="color:#6c5959;">Email</th>
...
?>
<script src="../javascript/admin_user.js"></script>
